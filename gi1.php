 ...
 include 'connexion.php';
                ...
                while ($donnee8=$query8->fetch()) {
                  if ($donnee8['Filiere']=='GI' && $donnee8['Niveau']=='1ere année') {
                ...
                echo"<td>";
                 while ($donnee33=$query33->fetch()) {
                  if ($donnee33['Filiere']=='GI' && $donnee33['Niveau']=='1ere année') {
                ...
                echo"<td>";
                 while ($donnee34=$query34->fetch()) {
                  if ($donnee34['Filiere']=='GI' && $donnee34['Niveau']=='1ere année') {
                ...
                echo"<td>";
                 while ($donnee35=$query35->fetch()) {
                  if ($donnee35['Filiere']=='GI' && $donnee35['Niveau']=='1ere année') {
                ...
                echo"<td>";
                 while ($donnee36=$query36->fetch()) {
                  if ($donnee36['Filiere']=='GI' && $donnee36['Niveau']=='1ere année') {
