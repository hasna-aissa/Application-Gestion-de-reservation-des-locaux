 ...
 include 'connexion.php';
                ...
                while ($donnee1=$query1->fetch()) {
                  if ($donnee1['Filiere']=='TM' && $donnee1['Niveau']=='2eme année') {
                ...
                while ($donnee2=$query2->fetch()) {
                  if ($donnee2['Filiere']=='TM' && $donnee2['Niveau']=='2eme année') {
                ...
                while ($donnee3=$query3->fetch()) {
                  if ($donnee3['Filiere']=='TM' && $donnee3['Niveau']=='2eme année') {
                ...
                echo"<td>";
                 while ($donnee4=$query4->fetch()) {
                  if ($donnee4['Filiere']=='TM' && $donnee4['Niveau']=='2eme année') {
                ...
                echo"<td>";
                 while ($donnee5=$query5->fetch()) {
                  if ($donnee5['Filiere']=='TM' && $donnee5['Niveau']=='2eme année') {
                ...
                echo"<td>";
                 while ($donnee6=$query6->fetch()) {
                  if ($donnee6['Filiere']=='TM' && $donnee6['Niveau']=='2eme année') {
                ...
                while ($donnee7=$query7->fetch()) {
                  if ($donnee7['Filiere']=='TM' && $donnee7['Niveau']=='2eme année') {
                ...
                while ($donnee8=$query8->fetch()) {
                  if ($donnee8['Filiere']=='TM' && $donnee8['Niveau']=='2eme année') {
                ...
                echo"<td>";
                 while ($donnee9=$query9->fetch()) {
                  if ($donnee9['Filiere']=='TM' && $donnee9['Niveau']=='2eme année') {
                ...
                echo"<td>";
                 while ($donnee10=$query10->fetch()) {
                  if ($donnee10['Filiere']=='TM' && $donnee10['Niveau']=='2eme année') {
                ...
                echo"<td>";
                 while ($donnee11=$query11->fetch()) {
                  if ($donnee11['Filiere']=='TM' && $donnee11['Niveau']=='2eme année') {
                ...
                echo"<td>";
                 while ($donnee12=$query12->fetch()) {
                  if ($donnee12['Filiere']=='TM' && $donnee12['Niveau']=='2eme année') {
                ...
                while ($donnee13=$query13->fetch()) {
                  if ($donnee13['Filiere']=='TM' && $donnee13['Niveau']=='2eme année') {
                ...
                while ($donnee14=$query14->fetch()) {
                  if ($donnee14['Filiere']=='TM' && $donnee14['Niveau']=='2eme année') {
                ...
                echo"<td>";
                 while ($donnee15=$query15->fetch()) {
                  if ($donnee15['Filiere']=='TM' && $donnee15['Niveau']=='2eme année') {
                ...
                echo"<td>";
                 while ($donnee16=$query16->fetch()) {
                  if ($donnee16['Filiere']=='TM' && $donnee16['Niveau']=='2eme année') {
                ...
                echo"<td>";
                 while ($donnee17=$query17->fetch()) {
                  if ($donnee17['Filiere']=='TM' && $donnee17['Niveau']=='2eme année') {
                ...
                echo"<td>";
                 while ($donnee18=$query18->fetch()) {
                  if ($donnee18['Filiere']=='TM' && $donnee18['Niveau']=='2eme année') {
                ...
                while ($donnee19=$query19->fetch()) {
                  if ($donnee19['Filiere']=='TM' && $donnee19['Niveau']=='2eme année') {
                ...
                while ($donnee20=$query20->fetch()) {
                  if ($donnee20['Filiere']=='TM' && $donnee20['Niveau']=='2eme année') {
                ...
                echo"<td>";
                 while ($donnee21=$query21->fetch()) {
                  if ($donnee21['Filiere']=='TM' && $donnee21['Niveau']=='2eme année') {
                ...
                echo"<td>";
                 while ($donnee22=$query22->fetch()) {
                  if ($donnee22['Filiere']=='TM' && $donnee22['Niveau']=='2eme année') {
                ...
                echo"<td>";
                 while ($donnee23=$query23->fetch()) {
                  if ($donnee23['Filiere']=='TM' && $donnee23['Niveau']=='2eme année') {
                ...
                echo"<td>";
                 while ($donnee24=$query24->fetch()) {
                  if ($donnee24['Filiere']=='TM' && $donnee24['Niveau']=='2eme année') {
                ...
                while ($donnee25=$query25->fetch()) {
                  if ($donnee25['Filiere']=='TM' && $donnee25['Niveau']=='2eme année') {
                ...
                while ($donnee26=$query26->fetch()) {
                  if ($donnee26['Filiere']=='TM' && $donnee26['Niveau']=='2eme année') {
                ...
                echo"<td>";
                 while ($donnee27=$query27->fetch()) {
                  if ($donnee27['Filiere']=='TM' && $donnee27['Niveau']=='2eme année') {
                ...
                echo"<td>";
                 while ($donnee28=$query28->fetch()) {
                  if ($donnee28['Filiere']=='TM' && $donnee28['Niveau']=='2eme année') {
                ...
                echo"<td>";
                 while ($donnee29=$query29->fetch()) {
                  if ($donnee29['Filiere']=='TM' && $donnee29['Niveau']=='2eme année') {
                ...
                echo"<td>";
                 while ($donnee30=$query30->fetch()) {
                  if ($donnee30['Filiere']=='TM' && $donnee30['Niveau']=='2eme année') {
                ...
                while ($donnee31=$query31->fetch()) {
                  if ($donnee31['Filiere']=='TM' && $donnee31['Niveau']=='2eme année') {
                ...
                while ($donnee32=$query32->fetch()) {
                  if ($donnee32['Filiere']=='TM' && $donnee32['Niveau']=='2eme année') {
                ...
                echo"<td>";
                 while ($donnee33=$query33->fetch()) {
                  if ($donnee33['Filiere']=='TM' && $donnee33['Niveau']=='2eme année') {
                ...
                echo"<td>";
                 while ($donnee34=$query34->fetch()) {
                  if ($donnee34['Filiere']=='TM' && $donnee34['Niveau']=='2eme année') {
                ...
                echo"<td>";
                 while ($donnee35=$query35->fetch()) {
                  if ($donnee35['Filiere']=='TM' && $donnee35['Niveau']=='2eme année') {
                ...
                echo"<td>";
                 while ($donnee36=$query36->fetch()) {
                  if ($donnee36['Filiere']=='TM' && $donnee36['Niveau']=='2eme année') {
