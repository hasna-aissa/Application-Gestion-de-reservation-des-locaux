    ...
    <!-- sidebar: style can be found in sidebar.less -->
     <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="ReserverSalleProf.php"><i class="fa fa-link"></i> <span>Reserver Local</span></a></li>
        <li class="active"><a href="GestionReservationProf.php"><i class="fa fa-link"></i> <span>Gestion Reservation</span></a></li>
        <li>
          <a href="emploiProf.php"><i class="fa fa-link"></i> <span>Emploi du temps</span>
          </a>
        </li>
      </ul>
      <!-- /.sidebar-menu -->
      ...
      $disponible=$ligne3['count(Idcreneu)'];
        ...
        <div class="col-lg-3 col-xs-6" style="height: 30%;width:30%">
          ...
          <div class="small-box bg-red" >
            ...
            <br>
            <a href="ReserverSalleProf.php" class="small-box-footer"> <i class="fa fa-arrow-circle-right"></i></a>
...
<?php  
 ...
 $query = "SELECT * FROM reservations r,local l,personnels p where l.IdLocal=r.IdLocal and p.IdPers=r.IdProf AND IdPers='".$_SESSION['IdPers']."'";  
...
if(isset($_POST['Rechercher']))
{
  ...
  $select=$_POST['select'];
  if($select=='filiere'){
  $query=$conn->query("SELECT * FROM reservations r,local l,personnels p where l.IdLocal=r.IdLocal and p.IdPers=r.IdProf and r.Filiere LIKE '%".$str."%'");  
                  ...
                  echo "<td>".$row['TimeDebut']."</td>";
                  echo "<td>".$row['TimeFin']."</td>";
...
<?php
                ...
                <span class="glyphicon glyphicon-trash"></span>
                  ...
                  <button type="button" class="btn btn-default" data-toggle="modal" data-target="#modal-default"><span class="glyphicon glyphicon-edit"></span></button>
                   ...
                   if($select=='niveau'){
  $query=$conn->query("SELECT * FROM reservations r,local l,personnels p where l.IdLocal=r.IdLocal and p.IdPers=r.IdProf and r.Niveau LIKE '%".$str."%'");  
                   while($row=$query->fetch()){
...
<?php
                ...
                <span class="glyphicon glyphicon-trash"></span>
                  ...
                  <button type="button" class="btn btn-default" data-toggle="modal" data-target="#modal-default"><span class="glyphicon glyphicon-edit"></span></button>
                   ...
                   if($select=='nom'){
  $query=$conn->query("SELECT * FROM reservations r,local l,personnels p where l.IdLocal=r.IdLocal and p.IdPers=r.IdProf and l.NomLocal LIKE '%".$str."%'");  
                   while($row=$query->fetch()){
