 ...
 include 'connexion.php';
                ...
                while ($donnee1=$query1->fetch()) {
                  if ($donnee1['Filiere']=='GBI' && $donnee1['Niveau']=='1ere année') {
                ...
                while ($donnee2=$query2->fetch()) {
                  if ($donnee2['Filiere']=='GBI' && $donnee2['Niveau']=='1ere année') {
                ...
                while ($donnee3=$query3->fetch()) {
                  if ($donnee3['Filiere']=='GBI' && $donnee3['Niveau']=='1ere année') {
                ...
                echo"<td>";
                 while ($donnee4=$query4->fetch()) {
                  if ($donnee4['Filiere']=='GBI' && $donnee4['Niveau']=='1ere année') {
                ...
                echo"<td>";
                 while ($donnee5=$query5->fetch()) {
                  if ($donnee5['Filiere']=='GBI' && $donnee5['Niveau']=='1ere année') {
                ...
                echo"<td>";
                 while ($donnee6=$query6->fetch()) {
                  if ($donnee6['Filiere']=='GBI' && $donnee6['Niveau']=='1ere année') {
                ...
                while ($donnee7=$query7->fetch()) {
                  if ($donnee7['Filiere']=='GBI' && $donnee7['Niveau']=='1ere année') {
                ...
                while ($donnee8=$query8->fetch()) {
                  if ($donnee8['Filiere']=='GBI' && $donnee8['Niveau']=='1ere année') {
                ...
                echo"<td>";
                 while ($donnee9=$query9->fetch()) {
                  if ($donnee9['Filiere']=='GBI' && $donnee9['Niveau']=='1ere année') {
                ...
                echo"<td>";
                 while ($donnee10=$query10->fetch()) {
                  if ($donnee10['Filiere']=='GBI' && $donnee10['Niveau']=='1ere année') {
                ...
                echo"<td>";
                 while ($donnee11=$query11->fetch()) {
                  if ($donnee11['Filiere']=='GBI' && $donnee11['Niveau']=='1ere année') {
                ...
                echo"<td>";
                 while ($donnee12=$query12->fetch()) {
                  if ($donnee12['Filiere']=='GBI' && $donnee12['Niveau']=='1ere année') {
                ...
                while ($donnee13=$query13->fetch()) {
                  if ($donnee13['Filiere']=='GBI' && $donnee13['Niveau']=='1ere année') {
                ...
                while ($donnee14=$query14->fetch()) {
                  if ($donnee14['Filiere']=='GBI' && $donnee14['Niveau']=='1ere année') {
                ...
                echo"<td>";
                 while ($donnee15=$query15->fetch()) {
                  if ($donnee15['Filiere']=='GBI' && $donnee15['Niveau']=='1ere année') {
                ...
                echo"<td>";
                 while ($donnee16=$query16->fetch()) {
                  if ($donnee16['Filiere']=='GBI' && $donnee16['Niveau']=='1ere année') {
                ...
                echo"<td>";
                 while ($donnee17=$query17->fetch()) {
                  if ($donnee17['Filiere']=='GBI' && $donnee17['Niveau']=='1ere année') {
                ...
                echo"<td>";
                 while ($donnee18=$query18->fetch()) {
                  if ($donnee18['Filiere']=='GBI' && $donnee18['Niveau']=='1ere année') {
                ...
                while ($donnee19=$query19->fetch()) {
                  if ($donnee19['Filiere']=='GBI' && $donnee19['Niveau']=='1ere année') {
                ...
                while ($donnee20=$query20->fetch()) {
                  if ($donnee20['Filiere']=='GBI' && $donnee20['Niveau']=='1ere année') {
                ...
                echo"<td>";
                 while ($donnee21=$query21->fetch()) {
                  if ($donnee21['Filiere']=='GBI' && $donnee21['Niveau']=='1ere année') {
                ...
                echo"<td>";
                 while ($donnee22=$query22->fetch()) {
                  if ($donnee22['Filiere']=='GBI' && $donnee22['Niveau']=='1ere année') {
                ...
                echo"<td>";
                 while ($donnee23=$query23->fetch()) {
                  if ($donnee23['Filiere']=='GBI' && $donnee23['Niveau']=='1ere année') {
                ...
                echo"<td>";
                 while ($donnee24=$query24->fetch()) {
                  if ($donnee24['Filiere']=='GBI' && $donnee24['Niveau']=='1ere année') {
                ...
                while ($donnee25=$query25->fetch()) {
                  if ($donnee25['Filiere']=='GBI' && $donnee25['Niveau']=='1ere année') {
                ...
                while ($donnee26=$query26->fetch()) {
                  if ($donnee26['Filiere']=='GBI' && $donnee26['Niveau']=='1ere année') {
                ...
                echo"<td>";
                 while ($donnee27=$query27->fetch()) {
                  if ($donnee27['Filiere']=='GBI' && $donnee27['Niveau']=='1ere année') {
                ...
                echo"<td>";
                 while ($donnee28=$query28->fetch()) {
                  if ($donnee28['Filiere']=='GBI' && $donnee28['Niveau']=='1ere année') {
                ...
                echo"<td>";
                 while ($donnee29=$query29->fetch()) {
                  if ($donnee29['Filiere']=='GBI' && $donnee29['Niveau']=='1ere année') {
                ...
                echo"<td>";
                 while ($donnee30=$query30->fetch()) {
                  if ($donnee30['Filiere']=='GBI' && $donnee30['Niveau']=='1ere année') {
                ...
                while ($donnee31=$query31->fetch()) {
                  if ($donnee31['Filiere']=='GBI' && $donnee31['Niveau']=='1ere année') {
                ...
                while ($donnee32=$query32->fetch()) {
                  if ($donnee32['Filiere']=='GBI' && $donnee32['Niveau']=='1ere année') {
                ...
                echo"<td>";
                 while ($donnee33=$query33->fetch()) {
                  if ($donnee33['Filiere']=='GBI' && $donnee33['Niveau']=='1ere année') {
                ...
                echo"<td>";
                 while ($donnee34=$query34->fetch()) {
                  if ($donnee34['Filiere']=='GBI' && $donnee34['Niveau']=='1ere année') {
                ...
                echo"<td>";
                 while ($donnee35=$query35->fetch()) {
                  if ($donnee35['Filiere']=='GBI' && $donnee35['Niveau']=='1ere année') {
                ...
                echo"<td>";
                 while ($donnee36=$query36->fetch()) {
                  if ($donnee36['Filiere']=='GBI' && $donnee36['Niveau']=='1ere année') {
