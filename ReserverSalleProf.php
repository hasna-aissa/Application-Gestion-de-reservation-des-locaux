  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="ReserverSalleProf.php"><i class="fa fa-link"></i> <span>Reserver Local</span></a></li>
        <li><a href="GestionReservationProf.php"><i class="fa fa-link"></i> <span>Gestion Reservation</span></a></li>
        <li >
         <a href="emploiProf.php"><i class="fa fa-link"></i> <span>Emploi du Temps</span></a>
        </li>
      </ul>
      <!-- /.sidebar-menu -->
    </section>
 ...
 include('RechercherType.php');                   
    ...
    ?>
      ...
      <div class="modal fade" id="modal-default">
        ...
        <form method="POST" action="ReserverLocalProf.php">
              ...
              <div class="row">
                <div class="col-xs-6">
                  <br><label for="inputState"  class="labelStyle">Time Debut</label>
                    <select id="combo_nomoi" name="TimeDebut">
