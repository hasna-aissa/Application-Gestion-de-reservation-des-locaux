...
<head>
  ...
  <link rel="stylesheet"
        ...
        <style type="text/css">
          .inputStyle{margin-left: 5%;margin-right: 20%}
          .inputFirstRow{margin-top: 5%}
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <!-- Main content -->
    <section class="content container-fluid" style="margin-left: 20%;margin-right: 30%;width: 60%">
    ...
    <div class="form-group inputStyle ">
      <label for="inputPassword4" class="labelStyle">Nom de salle</label>
      <input type="password" class="form-control" id="inputPassword4" placeholder="nom de salle" name="NomLocal">
    </div>
    <div class="form-group inputStyle">
    ...
    <div class="form-group inputStyle">
      ...
      <input type="text" class="form-control" id="inputCity" name="Effectif">
    </div>
    <div class="form-group inputStyle">
  ...
  <button type="submit" class="btn btn-success" style="margin-left: 40%" name="Ajouter">
    <span class="glyphicon glyphicon-download-alt"> Ajouter</span>
    </button>
                   <?php
