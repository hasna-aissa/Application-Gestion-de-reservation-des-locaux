                ...
                <ul class="menu">
                  <li><!-- start message -->
                    <a href="#">
                      <div class="pull-left">
                        <!-- User Image -->
                        <span  class="img-circle " alt="User Image" style="color: white"><img src="image/login.png" width="20px" height="20px"></span>
                      </div>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li ><a href="ReserverSalleProf.php"><i class="fa fa-link"></i> <span>Reserver Salle</span></a></li>
        <li><a href="GestionReservationProf.php"><i class="fa fa-link"></i> <span>Gestion Reservations</span></a></li>
        <li class="active">
