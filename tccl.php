 ...
 include 'connexion.php';
              $query1 = $conn->query("SELECT * FROM creneu WHERE TimeDebut='08:00' AND TimeFin='09:30 ' AND DayName(Date)='Monday' AND Date>= Date(NOW())" );
                ...
                while ($donnee1=$query1->fetch()) {
                  if ($donnee1['Filiere']=='TCC' && $donnee1['Niveau']=='Licence') {
                ...
                while ($donnee2=$query2->fetch()) {
                  if ($donnee2['Filiere']=='TCC' && $donnee2['Niveau']=='Licence') {
                ...
                while ($donnee3=$query3->fetch()) {
                  if ($donnee3['Filiere']=='TCC' && $donnee3['Niveau']=='Licence') {
                ...
                echo"<td>";
                 while ($donnee4=$query4->fetch()) {
                  if ($donnee4['Filiere']=='TCC' && $donnee4['Niveau']=='Licence') {
                ...
                echo"<td>";
                 while ($donnee5=$query5->fetch()) {
                  if ($donnee5['Filiere']=='TCC' && $donnee5['Niveau']=='Licence') {
                ...
                echo"<td>";
                 while ($donnee6=$query6->fetch()) {
                  if ($donnee6['Filiere']=='TCC' && $donnee6['Niveau']=='Licence') {
                ...
                while ($donnee7=$query7->fetch()) {
                  if ($donnee7['Filiere']=='TCC' && $donnee7['Niveau']=='Licence') {
                ...
                while ($donnee8=$query8->fetch()) {
                  if ($donnee8['Filiere']=='TCC' && $donnee8['Niveau']=='Licence') {
                ...
                echo"<td>";
                 while ($donnee9=$query9->fetch()) {
                  if ($donnee9['Filiere']=='TCC' && $donnee9['Niveau']=='Licence') {
                ...
                echo"<td>";
                 while ($donnee10=$query10->fetch()) {
                  if ($donnee10['Filiere']=='TCC' && $donnee10['Niveau']=='Licence') {
                ...
                echo"<td>";
                 while ($donnee11=$query11->fetch()) {
                  if ($donnee11['Filiere']=='TCC' && $donnee11['Niveau']=='Licence') {
                ...
                echo"<td>";
                 while ($donnee12=$query12->fetch()) {
                  if ($donnee12['Filiere']=='TCC' && $donnee12['Niveau']=='Licence') {
                ...
                while ($donnee13=$query13->fetch()) {
                  if ($donnee13['Filiere']=='TCC' && $donnee13['Niveau']=='Licence') {
                ...
                while ($donnee14=$query14->fetch()) {
                  if ($donnee14['Filiere']=='TCC' && $donnee14['Niveau']=='Licence') {
                ...
                echo"<td>";
                 while ($donnee15=$query15->fetch()) {
                  if ($donnee15['Filiere']=='TCC' && $donnee15['Niveau']=='Licence') {
                ...
                echo"<td>";
                 while ($donnee16=$query16->fetch()) {
                  if ($donnee16['Filiere']=='TCC' && $donnee16['Niveau']=='Licence') {
                ...
                echo"<td>";
                 while ($donnee17=$query17->fetch()) {
                  if ($donnee17['Filiere']=='TCC' && $donnee17['Niveau']=='Licence') {
                ...
                echo"<td>";
                 while ($donnee18=$query18->fetch()) {
                  if ($donnee18['Filiere']=='TCC' && $donnee18['Niveau']=='Licence') {
                ...
                while ($donnee19=$query19->fetch()) {
                  if ($donnee19['Filiere']=='TCC' && $donnee19['Niveau']=='Licence') {
                ...
                while ($donnee20=$query20->fetch()) {
                  if ($donnee20['Filiere']=='TCC' && $donnee20['Niveau']=='Licence') {
                ...
                echo"<td>";
                 while ($donnee21=$query21->fetch()) {
                  if ($donnee21['Filiere']=='TCC' && $donnee21['Niveau']=='Licence') {
                ...
                echo"<td>";
                 while ($donnee22=$query22->fetch()) {
                  if ($donnee22['Filiere']=='TCC' && $donnee22['Niveau']=='Licence') {
                ...
                echo"<td>";
                 while ($donnee23=$query23->fetch()) {
                  if ($donnee23['Filiere']=='TCC' && $donnee23['Niveau']=='Licence') {
                ...
                echo"<td>";
                 while ($donnee24=$query24->fetch()) {
                  if ($donnee24['Filiere']=='TCC' && $donnee24['Niveau']=='Licence') {
                ...
                while ($donnee25=$query25->fetch()) {
                  if ($donnee25['Filiere']=='TCC' && $donnee25['Niveau']=='Licence') {
                ...
                while ($donnee26=$query26->fetch()) {
                  if ($donnee26['Filiere']=='TCC' && $donnee26['Niveau']=='Licence') {
                ...
                echo"<td>";
                 while ($donnee27=$query27->fetch()) {
                  if ($donnee27['Filiere']=='TCC' && $donnee27['Niveau']=='Licence') {
                ...
                echo"<td>";
                 while ($donnee28=$query28->fetch()) {
                  if ($donnee28['Filiere']=='TCC' && $donnee28['Niveau']=='Licence') {
                ...
                echo"<td>";
                 while ($donnee29=$query29->fetch()) {
                  if ($donnee29['Filiere']=='TCC' && $donnee29['Niveau']=='Licence') {
                ...
                echo"<td>";
                 while ($donnee30=$query30->fetch()) {
                  if ($donnee30['Filiere']=='TCC' && $donnee30['Niveau']=='Licence') {
                ...
                while ($donnee31=$query31->fetch()) {
                  if ($donnee31['Filiere']=='TCC' && $donnee31['Niveau']=='Licence') {
                ...
                while ($donnee32=$query32->fetch()) {
                  if ($donnee32['Filiere']=='TCC' && $donnee32['Niveau']=='Licence') {
                ...
                echo"<td>";
                 while ($donnee33=$query33->fetch()) {
                  if ($donnee33['Filiere']=='TCC' && $donnee33['Niveau']=='Licence') {
                ...
                echo"<td>";
                 while ($donnee34=$query34->fetch()) {
                  if ($donnee34['Filiere']=='TCC' && $donnee34['Niveau']=='Licence') {
                ...
                echo"<td>";
                 while ($donnee35=$query35->fetch()) {
                  if ($donnee35['Filiere']=='TCC' && $donnee35['Niveau']=='Licence') {
                ...
                echo"<td>";
                 while ($donnee36=$query36->fetch()) {
                  if ($donnee36['Filiere']=='TCC' && $donnee36['Niveau']=='Licence') {
